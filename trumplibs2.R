...
trump_libs <- function(...){
    ...
    enemies = c('Adam Schiff', 'Antifa', 'Al Franken', 'Alicia Machado', 'Anderson Cooper', 'Anthony Weiner', 'Arnold Schwartzenegger', 'Barack Obama',
                ...
                'Jon Ossoff', 'Juan Williams', 'Kathy Griffin', 'Katie Couric', 'Lawrence O\'Donnell', 'Lebanon', 'Loretta Lynch', 'Marco Rubio', 'Mark Cuban', 
    ...
    adjective = c('SAD!', 'BAD!', 'TERRIBLE!', 'APOLOGIZE!', 
                  'COVFEFE!', 'HEEL!', 'MANY SIDES!', 'Our poor country!')
